...
import sty from "./PlasmicButton.module.css"; // plasmic-import: bJNR9igOVaPK/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: 6MLaliudcYvo/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: Ms8D4f12n9A_/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__ql0Dp)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__d2LX0)}
                role={"img"}
              />
            ),
